...
import { WeightedVoteOption } from "canvas-client-ts/cosmos.gov.v1beta1/types"
import { TextProposal } from "canvas-client-ts/cosmos.gov.v1beta1/types"
import { Deposit } from "canvas-client-ts/cosmos.gov.v1beta1/types"
import { Proposal } from "canvas-client-ts/cosmos.gov.v1beta1/types"
import { TallyResult } from "canvas-client-ts/cosmos.gov.v1beta1/types"
import { Vote } from "canvas-client-ts/cosmos.gov.v1beta1/types"
import { DepositParams } from "canvas-client-ts/cosmos.gov.v1beta1/types"
import { VotingParams } from "canvas-client-ts/cosmos.gov.v1beta1/types"
import { TallyParams } from "canvas-client-ts/cosmos.gov.v1beta1/types"
